...
- `.pdf`: provalmente um arquivo com a documentação da pesquisa.
...
## *Bônus:* como ler todos os arquivos! {.smaller}
...
- Solução 1: uma linha de comando para cada arquivo.
    - Copiar 27 vezes a mesma linha de código (mudando apenas o nome do arquivo), depois fazer varios `rbind`.
...
## *Bônus:* como ler todos os arquivos
